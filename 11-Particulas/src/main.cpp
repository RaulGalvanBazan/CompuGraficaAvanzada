...
=======
>>>>>>> 2714dbe3e5af8ecbb77cd5beb4ec9d53ce62d8d0
...
void initParticlesBuffer() {
    //Genera los buffers
    glGenBuffers(1, &initVel);  //Buffer para la velocidad inicial
    glGenBuffers(1, &startTime);    //Buffer para el tiempo de inicio
    ...
    //Se genera el tiempo inicial de vida de la particula
    delete[] data;
...
void destroy() {
    ...
    //Eliminar los buffers del sistema de partículas
    glBindBuffer(GL_ARRAY_BUFFER, 0);
...
<<<<<<< HEAD
    ...
    while (psi) {
        ...
        //Setea la matriz de vista y proyeccion al shader del sistema de particulas de la fuente de agua
        ...
        shaderMulLighting.setFloat("density", 0.001);
        shaderTerrain.setFloat("density", 0.001);
        shaderSkybox.setFloat("lowerLimit", 0.001);
        ...
        for (std::map<float, std::pair<std::string, glm::vec3> >::reverse_iterator it = blendingSorted.rbegin(); it != blendingSorted.rend(); it++) {
            ...
            modelMatrixParticlesFountain[3][1] = terrain.getHeightTerrain(modelMatrixParticlesFountain[3][0], modelMatrixParticlesFountain[3][2]) * 0.96 * 10.0;
            modelMatrixParticlesFountain = glm::scale(modelMatrixParticlesFountain, glm::vec3(3.0));
            currTimeParticlesAnimation = TimeManager::Instance().GetTime(); //Se obtiene tiempo en milisegundos
            ...
            ShaderParticlesFountain.setMatrix4("model", 1, GL_FALSE, glm::value_ptr(modelMatrixParticlesFountain));
            glBindVertexArray(VAOParticles);
